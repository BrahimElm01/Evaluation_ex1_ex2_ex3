...
public class MainEtatCivil {
    public static void main(String[] args) {
        ...
        Homme h1 = new Homme(); h1.setNom("ELMAJDAOUI"); h1.setPrenom("BRAHIM");
        h1.setDateNaissance(LocalDate.of(1960, 1, 1)); hommeSrv.create(h1);

        Homme h2 = new Homme(); h2.setNom("AMRANI"); h2.setPrenom("ALI");
        h2.setDateNaissance(LocalDate.of(1965, 2, 2)); hommeSrv.create(h2);



        Femme f1 = new Femme(); f1.setNom("SALIMA"); f1.setPrenom("RAMI"); f1.setDateNaissance(LocalDate.of(1965,3,1));
        Femme f2 = new Femme(); f2.setNom("AMAL");   f2.setPrenom("ALI");  f2.setDateNaissance(LocalDate.of(1970,4,2));
        Femme f3 = new Femme(); f3.setNom("WAFA");   f3.setPrenom("ALAOUI"); f3.setDateNaissance(LocalDate.of(1972,5,3));
        Femme f4 = new Femme(); f4.setNom("KARIMA"); f4.setPrenom("ALAMI"); f4.setDateNaissance(LocalDate.of(1968,6,4));
        // … f5..f10
